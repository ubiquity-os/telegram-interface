...
STEPS=(
  ...
  "./deploy.sh $ENVIRONMENT $DENO_DEPLOY_TOKEN $DENO_PROJECT_NAME $DENO_PREVIEW_PROJECT_NAME $BOT_TOKEN $PREVIEW_BOT_TOKEN $WEBHOOK_SECRET_PRODUCTION $WEBHOOK_SECRET_PREVIEW $OPENROUTER_API_KEY"
